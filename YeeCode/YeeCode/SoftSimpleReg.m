%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Simulating a wave reflecting off a rectangular material
%
% "***" denotes changes made for assignment PA
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
epi{1}(100:150,100:150) = c_eps_0*11.3;
epi{1}(100:150,10:50) = c_eps_0*11.3;
epi{1}(100:150,50:100) = c_eps_0*11.3;

% *** New Structure for Scattering ***
for s = 1:20
    s_start = 60;
    range = s_start+s*2;
    epi{1}(125:150,range:range) = c_eps_0*11.3;
end
...
% Setting up sources! ---> (bc = Boundary Conditions)
bc{1}.NumS = 1;
